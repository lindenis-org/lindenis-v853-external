...
elseif(${BACKEND_TYPE} STREQUAL "WAYLAND")
  add_definitions(-DWL_EGL_PLATFORM)
else()
  add_definitions(-DUSE_EGLFS)
endif()
...
elseif(${BACKEND_TYPE} STREQUAL "WAYLAND")
  ...
  add_definitions(-DDISPLAY_BACKEND_TYPE_EGLFS)
  add_definitions(-DFLUTTER_TARGET_BACKEND_EGLFS)
  set(DISPLAY_BACKEND_SRC
    "src/flutter/shell/platform/linux_embedded/window/elinux_window_eglfs.cc"
    "src/flutter/shell/platform/linux_embedded/window/native_window_eglfs.cc")
endif()
