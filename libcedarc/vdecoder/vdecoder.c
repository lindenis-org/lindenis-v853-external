                      ...
                      int64_t       nCurrentTimeUs)
{
    ...
    dy_log("DecodeVideoStream, pDecoder=%p, \
                             ...
                             int           nStreamBufIndex)
{
    ...
    dy_log("RequestVideoStreamBuffer, pDecoder=%p, nRequireSize=%d, nStreamBufIndex=%d",
...
int VideoStreamBufferSize(VideoDecoder* pDecoder, int nStreamBufIndex)
{
    ...
    dy_log("VideoStreamBufferSize, nStreamBufIndex=%d", nStreamBufIndex);
...
int VideoStreamDataSize(VideoDecoder* pDecoder, int nStreamBufIndex)
{
    ...
    dy_log("VideoStreamDataSize, nStreamBufIndex=%d", nStreamBufIndex);
...
VideoPicture* RequestPicture(VideoDecoder* pDecoder, int nStreamIndex)
{
    ...
    dy_log("RequestPicture, nStreamIndex=%d", nStreamIndex);
...
int ReturnPicture(VideoDecoder* pDecoder, VideoPicture* pPicture)
{
    ...
    dy_log("ReturnPicture, pPicture=%p", pPicture);
