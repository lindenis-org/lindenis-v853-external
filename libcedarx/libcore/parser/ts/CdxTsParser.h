...
#define CDX_STREAM_TYPE_AUDIO_AAC       0x0f // ISO/IEC 13818-7 Audio with ADTS transport syntax
#define CDX_STREAM_TYPE_VIDEO_MPEG4     0x10
#define CDX_STREAM_TYPE_AUDIO_MPEG4     0x11
#define CDX_STREAM_TYPE_OMX_VIDEO_CodingAVC      0x1b // AVC video stream as defined in ITU-T Rec. H.264 | ISO/IEC 14496-10 Video, or AVC base layer of an HEVC video stream as defined in ITU-T H.265 | ISO/IEC 23008-2
...
#define CDX_STREAM_TYPE_AUDIO_AC3       0x81  // User Private / AC-3 (ATSC)
#define CDX_STREAM_TYPE_AUDIO_HDMV_DTS  0x82
#define CDX_STREAM_TYPE_AUDIO_AC3_TRUEHD    0x83
#define CDX_STREAM_TYPE_AUDIO_EAC3      0x87 // User Private / E-AC-3 (ATSC)
...
#define CDX_STREAM_TYPE_H264_ENCRYPTED 0xdb
#define CDX_STREAM_TYPE_AAC_ENCRYPTED 0xcf
#define CDX_STREAM_TYPE_AC3_ENCRYPTED 0xc1
...
struct TSParserS
{
	...
	SampleEncryptInfoT mSampleKeyItem;
    CdxDecryptorT* pDecryptor;
};
