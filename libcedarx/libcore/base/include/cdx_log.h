...
#define AWLOG(systag, level, fmt, arg...)  \
    do { \
        if ((level >= GLOBAL_LOG_LEVEL || level >= CONFIG_LOG_LEVEL) && \
...
#define CDX_LOGV(fmt, arg...) AWLOG(LOG_DEBUG, LOG_LEVEL_VERBOSE, fmt, ##arg)
#define CDX_LOGD(fmt, arg...) AWLOG(LOG_DEBUG, LOG_LEVEL_DEBUG, fmt, ##arg)
#define CDX_LOGI(fmt, arg...) AWLOG(LOG_INFO, LOG_LEVEL_INFO, fmt, ##arg)
#define CDX_LOGW(fmt, arg...) AWLOG(LOG_WARNING, LOG_LEVEL_WARNING, fmt, ##arg)
#define CDX_LOGE(fmt, arg...) AWLOG(LOG_ERR, LOG_LEVEL_ERROR, "\033[40;31m" fmt "\033[0m", ##arg)
...
#define loge(fmt, arg...) AWLOG(LOG_ERR, LOG_LEVEL_ERROR, "\033[40;31m" fmt "\033[0m", ##arg)
#define logw(fmt, arg...) AWLOG(LOG_WARNING, LOG_LEVEL_WARNING, fmt, ##arg)
#define logi(fmt, arg...) AWLOG(LOG_INFO, LOG_LEVEL_INFO, fmt, ##arg)
#define logd(fmt, arg...) AWLOG(LOG_DEBUG, LOG_LEVEL_DEBUG, fmt, ##arg)
#define logv(fmt, arg...) AWLOG(LOG_DEBUG, LOG_LEVEL_VERBOSE, fmt, ##arg)
